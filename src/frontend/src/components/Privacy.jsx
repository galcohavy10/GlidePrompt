        ...
        <div className='text-white px-4 py-5'>
            <div className='max-w-[1240px] w-full mx-auto text-left flex flex-col justify-center'>
                ...
                <p className='text-xl font-medium p-2'>
                    ...
                    <br /><br />
                    At NexaFlow, we value your privacy and are committed to ensuring that your personal information is protected.
                    ...
                    <br />
                    NexaFlow does not sell or rent your personal information to third parties. Your information is transmitted
                    ...
                    <br /><br />
                    If you have any questions or concerns about this policy, please contact us at galswlr@gmail.com.
                </p>
            </div>
        </div>
    );
