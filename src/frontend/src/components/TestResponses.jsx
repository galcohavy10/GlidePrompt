...
import ChatResponsePreview from './Demo/ChatResponsePreview'; 
  ...
  <div className="flex flex-col items-center min-h-screen bg-gradient-to-r from-[#79fcd3] to-[#00df9a] p-4">
    ...
    {isEditingSystemMessage ? (
      <>
        ...
        <div onClick={handleEditUserTask} className="cursor-pointer flex items-center justify-between p-3 text-sm text-gray-800 bg-slate-100 rounded-full border border-gray-300 shadow-sm mb-4 hover:bg-gray-400 transition-all duration-200 ease-in-out mx-4">
      ...
      <div className="w-full max-w-4xl p-6 md:p-10 space-y-4 bg-white rounded-lg shadow-xl flex flex-col">
        <DemoStatusBar currentStep={currentStep} />
      <div onClick={handleEditSystemMessage} className="cursor-pointer flex items-center justify-between p-3 text-sm text-gray-800 bg-slate-100 rounded-full border border-gray-300 shadow-sm mb-4 hover:bg-gray-100 transition-all duration-200 ease-in-out mx-4">
          <div className="flex items-center gap-2">
