...
function TestResponsesDemo({ initialPrompt, goToFirstStep, initialTask }) {
  ...
  <div className="flex flex-col items-center min-h-screen bg-gradient-to-r from-[#79fcd3] to-[#00df9a] p-4">
    ...
    {isEditingSystemMessage ? (
      <>
        ...
        <form onSubmit={handleSaveSystemMessage} className="relative w-full max-w-4xl px-8 py-10 md:px-12 md:py-10 space-y-6 bg-white rounded-lg shadow-xl transition-all z-10">
        <DemoStatusBar currentStep={currentStep} />

          
        <div onClick={handleEditUserTask} className="cursor-pointer flex items-center justify-between p-3 text-sm text-gray-800 bg-slate-100 rounded-full border border-gray-300 shadow-sm mb-4 hover:bg-gray-400 transition-all duration-200 ease-in-out mx-4 max-w-4xl">
      ...
      <div className="flex flex-col w-full max-w-4xl p-5 md:p-10 space-y-4 bg-white rounded-lg shadow-xl">
      <DemoStatusBar currentStep={currentStep} />
      <div onClick={handleEditSystemMessage} className="cursor-pointer flex items-center justify-between p-3 text-sm text-gray-800 bg-slate-100 rounded-full border border-gray-300 shadow-sm mb-4 hover:bg-gray-100 transition-all duration-200 ease-in-out w-full max-w-4xl mx-4">
          <div className="flex items-center gap-2">
        ...
        <div className="w-full max-w-4xl flex flex-col md:flex-row gap-4">
          ...
          <div className="w-full md:w-2/4 flex flex-col gap-4">
            <div className="bg-slate-100 p-2 rounded-md shadow-xl">
          <h2 className="text-xl font-semibold text-gray-800 ">Test Results</h2>
          <p className="text-sm text-gray-600">See pricing and outputs.</p>
            </div>
...
export default TestResponsesDemo;
